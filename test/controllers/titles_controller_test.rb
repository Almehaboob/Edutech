...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference("Title.count") do
      post titles_url, params: { title: { content: @title.content, course_id: @title.course_id } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { content: @title.content, course_id: @title.course_id } }
